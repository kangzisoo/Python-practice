...
code_list = ['005930', '005250', '005380', '128940']
name_list = ['삼성전자', '녹십자홀딩스', '현대차', '한미약품']

for index in range(len(code_list)):
    con = request.urlopen('https://www.op.gg/statistics/champion/=') #연결부품획득
    #print('1. 연결 성공', con)
    ...
    file = open(name_list[index] + '.txt', 'w')   # open() 파일을 만드는 함수
    file.write('코드:' + code + '\n')
